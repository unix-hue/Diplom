...
public class DeskRVAdapter extends RecyclerView.Adapter <DeskRVAdapter.ViewHolder>{
    ...
    //Захват item.xml в качестве элемента списка
    @NonNull
    @Override
    ...
    //Класс, дающий доступ к объектам itema
    ...
    //Отслеживание нажатий на элемент списка
    final private View.OnClickListener onClickListener = new View.OnClickListener()
    {
        @Override
        public void onClick(View view)
        {
            Desk item = (Desk) view.getTag();
            Context context = view.getContext();
            Intent intent = new Intent(deskActivity, TasksActivity.class);
            intent.putExtra("desk", item.getName());
